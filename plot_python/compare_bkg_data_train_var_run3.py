...
for primary_process_name, tree_name in Tree_dict.items(): 
    ...
    for i in config_dict:
        ...
        # ggF
        if primary_process_name == "ggF":
            ax1.legend(fontsize=16, ncol=2, handletextpad=0.4, columnspacing=0.5, bbox_to_anchor=(0.99, 1.01),loc="upper right", frameon=False, handlelength=0.7, handleheight=1.2, labelspacing=0.1)

        # VBF
        elif primary_process_name == "VBF":
            ax1.legend(fontsize=17, ncol=2, handletextpad=0.4, columnspacing=0.5, bbox_to_anchor=(0.99, 1.01),loc="upper right", frameon=False, handlelength=0.7, handleheight=1.2, labelspacing=0.1)
