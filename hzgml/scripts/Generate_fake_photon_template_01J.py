    ...
    def applyBDT(self, category, scale=1):
        ...
        with uproot.recreate(output_path) as output_file:
            ...
            for filename in tqdm(sorted(f_list), desc='XGB INFO: Applying BDTs to %s samples' % category, bar_format='{desc}: {percentage:3.0f}%|{bar:20}{r_bar}'):
                ...
                # Load the data
                gamma_mvaID_dist_B = pd.read_pickle("/eos/user/j/jiehan/data_for_norm_float_v1/gamma_mvaID_01J_B.pkl")['gamma_mvaID']
                gamma_mvaID_dist_E = pd.read_pickle("/eos/user/j/jiehan/data_for_norm_float_v1/gamma_mvaID_01J_E.pkl")['gamma_mvaID']
...
def main():
    ...
    sample_list = ["Data", "ZGToLLG", "ZG2JToG2L2J", "DYJets_01J"] # "Data", "ZGToLLG", "ZG2JToG2L2J", "DYJets_01J"
