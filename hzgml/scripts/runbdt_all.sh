...
# Tune 1 set of hyperparameter
# python scripts/train_bdt.py -r two_jet --optuna --n-calls 60 --continue-optuna 0 --optuna_metric 'eval_auc_minus_train_auc' --oneHyperparameter --inputFolder "/eos/home-j/jiehan/root/skimmed_ntuples_rui_new" --reweight
# # Train with 1 set of hyperparameter
# python scripts/train_bdt.py -r two_jet --save --inputFolder "/eos/home-j/jiehan/root/skimmed_ntuples_rui_new" --reweight --oneHyperparameter  --hyperparams_path "models/optuna_two_jet"
# # Apply
