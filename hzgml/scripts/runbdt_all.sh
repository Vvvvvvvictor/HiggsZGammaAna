...
###########################################################
python scripts/categorization_1D.py -r zero_jet -b 4 -s $S -a $A
python scripts/categorization_1D.py -r one_jet -b 4 -s $S -a $A
python scripts/categorization_1D.py -r two_jet -b 4 -s $S -a $A
python scripts/categorization_1D.py -r VH_ttH -b 4 -s $S -a $A
