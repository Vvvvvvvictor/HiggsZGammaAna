...
def getArgs():
    ...
    parser.add_argument('-m', '--mode', action='store', choices=['inclusive', 'per_category', 'per_process', "H_mass", "BDT_sideband_center_ratio"], default='inclusive', help='run mode')
...
def plotVars(region, category=None, category_name=None, categorization='Event_XGB_16_Category'):
        ...
        #samples = OrderedDict([
            #('Data sideband', {'process': ['data'], 'selection': 'weight_central*(H_mass>=120&&H_mass<=130)', 'color': ROOT.kBlack}),
            # ('Data center', {'process': ['data'], 'selection': 'weight_central*(H_mass>=120&&H_mass<=130)', 'color': ROOT.kBlack, 'width': 3}),
            #('MC bkg sideband', {'process': ['Z', 'ttbar', 'diboson', 'stop'], 'selection': 'weight_central*((H_mass>=110&&H_mass<=180)&&!(H_mass>=120&&H_mass<=130))', 'color': ROOT.kBlue}),
            #('MC bkg center', {'process': ['Z', 'ttbar', 'diboson', 'stop'], 'selection': 'weight_central*(H_mass>=120&&H_mass<=130)', 'color': ROOT.kBlue, 'width': 3}),
            #('VBF simulation', {'process': ['VBF'], 'selection': 'weight_central*(H_mass>=120&&H_mass<=130)', 'color': ROOT.kRed, 'width': 3}),
            #('ggF simulation', {'process': ['ggH'], 'selection': 'weight_central*(H_mass>=120&&H_mass<=130)', 'color': ROOT.kOrange+2, 'width': 3}),
        #])
    ...
    samples = OrderedDict([
        ('Data', {'process': ['data'], 'selection': 'weight_central*(H_mass>=100&&H_mass<=180)', 'color': ROOT.kBlack}),
        # ('Data center', {'process': ['data'], 'selection': 'weight_central*(H_mass>=120&&H_mass<=130)', 'color': ROOT.kBlack, 'width': 3}),
        #('MC bkg sideband', {'process': ['Z', 'ttbar', 'diboson', 'stop'], 'selection': 'weight_central*((H_mass>=100&&H_mass<=180)&&!(H_mass>=120&&H_mass<=130))', 'color': ROOT.kBlue}),
        #('MC bkg center', {'process': ['Z', 'ttbar', 'diboson', 'stop'], 'selection': 'weight_central*(H_mass>=120&&H_mass<=130)', 'color': ROOT.kBlue, 'width': 3}),
        ('H #rightarrow llg simulation', {'process': ['ggH', 'VBF', 'WminusH', 'WplusH', 'ZH', 'ttH'], 'selection': 'weight_central*(H_mass>=100&&H_mass<=180)', 'color': ROOT.kRed, 'width': 3})
    ])

    plot_var(samples, region, 'H_mass', 'mass_{llg} [GeV]', 40, 100, 180, category=category, category_name=category_name, categorization=categorization)
    plot_var(samples, region, 'H_pt', 'p_{T}^{llg} [GeV]', 40, 0, 200, category=category, category_name=category_name, categorization=categorization)
    plot_var(samples, region, 'H_eta', '#eta_{llg}', 30, -3, 3, category=category, category_name=category_name, categorization=categorization)
    ...
    plot_var(samples, region, 'n_jets', 'number of jets', 6, 0, 5, text_label=['0', '1', '2', '3', '4', '>=5'], category=category, category_name=category_name, categorization=categorization)
    plot_var(samples, region, 'n_leptons', 'number of leptons', 6, 0, 5, text_label=['0', '1', '2', '3', '4', '>=5'], category=category, category_name=category_name, categorization=categorization)

    if region == 'one_jet' or region == 'two_jet':
        plot_var(samples, region, 'jet_1_pt', 'p_{T}^{j_{#scale[1]{1}}} [GeV]', 20, 0, 300, category=category, category_name=category_name, categorization=categorization)
        ...
        #plot_var(samples, region, 'DeltaPhi_mumuj1', '#Delta#phi_{llg,j_{1}}', 20, -3.14, 3.14, category=category, category_name=category_name, categorization=categorization)
    ...
    if region == 'two_jet':
        plot_var(samples, region, 'jet_2_pt', 'p_{T}^{j_{#scale[1]{2}}} [GeV]', 20, 0, 200, category=category, category_name=category_name, categorization=categorization)
        ...
        #plot_var(samples, region, 'DeltaPhi_mumuj2', '#Delta#phi_{llg,j_{2}}', 20, -3.14, 3.14, category=category, category_name=category_name, categorization=categorization)
        ...
        #plot_var(samples, region, 'DeltaPhi_mumujj', '#Delta#phi_{llg,jj}', 20, -3.14, 3.14, category=category, category_name=category_name, categorization=categorization)
        ...
        # plot_var(samples, region,'DeltaPhi_mumuMET', '#Delta#phi_{llg,MET}', 20, -3.14, 3.14, category=category, category_name=category_name, categorization=categorization)
...
def plot_H_mass(categorization='Event_Paper_Category'):
    ...
    samples = OrderedDict([
        ('Data sideband', {'process': ['data_sid'], 'selection': 'weight_central*(H_mass>=110&&H_mass<=160)', 'color': ROOT.kBlack}),
        ('Higgs signal', {'process': ['VBF', 'VH', 'ggF', 'ttH'], 'selection': 'weight_central*(H_mass>=110&&H_mass<=160)', 'color': ROOT.kRed, 'width': 3}),
        ('MC bkg', {'process': ['Z', 'ttbar', 'diboson', 'stop'], 'selection': 'weight_central*(H_mass>=110&&H_mass<=160)', 'color': ROOT.kBlue}),
    ])
    ...
    for category in categories:
        ...
        plot_var(samples, region, 'H_mass', 'm_{llg} [GeV]', 10, 110, 160, category=category, category_name=categories[category], categorization=categorization)
...
def plotVars_ratio(region, category=None, category_name=None, categorization='Event_XGB_16_Category'):
    ...
    if not category:
        ...
        samples = OrderedDict([
            # ('Data sideband', {'process': ['data_sid'], 'selection': 'weight_central*(H_mass>=110&&H_mass<=180)', 'color': ROOT.kBlack, 'ratio': 'Data center'}),
            # ('Data center', {'process': ['data_cen'], 'selection': 'weight_central*(H_mass>=120&&H_mass<=130)', 'color': ROOT.kBlue+3, 'style': 2, 'ratio': 'numerator'}),
            ('VBF', {'process': ['VBF'], 'selection': 'weight_central*(H_mass>=120&&H_mass<=130)', 'color': ROOT.kRed, 'width': 3}),
            ('ggF', {'process': ['ggF'], 'selection': 'weight_central*(H_mass>=120&&H_mass<=130)', 'color': ROOT.kOrange+2, 'width': 3}),
            ('MC bkg sideband', {'process': ['Z', 'ttbar', 'diboson', 'stop'], 'selection': 'weight_central*((H_mass>=110&&H_mass<=180)&&!(H_mass>=120&&H_mass<=130))', 'color': ROOT.kBlue, 'ratio': 'MC bkg center'}),
            ('MC bkg center', {'process': ['Z', 'ttbar', 'diboson', 'stop'], 'selection': 'weight_central*(H_mass>=120&&H_mass<=130)', 'color': ROOT.kGreen+2, 'ratio': 'numerator'})
        ])
...
def main():
    ...
    if args.mode == 'inclusive':
        ...
        regions = ['inclusive', 'zero_jet', 'one_jet', 'two_jet']
    ...
    elif args.mode == 'H_mass':

        plot_H_mass(categorization=args.categorization)
