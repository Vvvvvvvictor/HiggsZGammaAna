...
# python3 -m venv /eos/user/${USER::1}/$USER/HZgamma/Machine_Learning/hzg-pku-hzgml/
source /eos/user/${USER::1}/$USER/HZgamma/Machine_Learning/hzg-pku-hzgml/bin/activate

export PYTHONPATH="/eos/user/${USER::1}/$USER/HZgamma/Machine_Learning/hzg-pku-hzgml/lib/python3.9/site-packages/:$PYTHONPATH"
