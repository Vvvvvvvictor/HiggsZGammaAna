...
# rm -rf eos_logs/data/Data_2016*
# rm -rf /eos/user/j/jiehan/parquet/nanov9/data/Data_2016*
...
# rm -rf eos_logs/bkgmc/ZGToLLG_*
# rm -rf /eos/user/j/jiehan/parquet/nanov9/bkgmc/ZGToLLG_*
