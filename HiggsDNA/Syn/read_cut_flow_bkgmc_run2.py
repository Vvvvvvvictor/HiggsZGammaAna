...
log_path = '/afs/cern.ch/work/p/pelai/HZgamma/Output/HiggsDNA/Syn/eos_logs/run2/'
...
dataset_type = 'Bkg_MC'
dataset_names = ["DYJetsToLL", "ZGToLLG", "ZG2JToG2L2J"] # "DYJetsToLL", "EWKZ2J", "ZG2JToG2L2J" "ZGToLLG" "Data_SingleMuon", "Data_DoubleMuon", "Data_SingleElectron", "Data_DoubleEG"
