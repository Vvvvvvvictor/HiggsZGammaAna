...
def select_electrons(electrons, options, clean, name = "none", tagger = None):
    ...
    if options["id"] == "WP90":
        ...
        # id_cut = electrons.mvaFall17V2Iso_WP90 == True # run3: run2 selection
    elif options["id"] == "WP80":
        id_cut = electrons.mvaIso_WP80 == True # run3
        # id_cut = electrons.mvaFall17V2Iso_WP80 == True # run3: run2 selection
    elif options["id"] == "WPL":
        id_cut = electrons.mvaIso_WPL == True # run3
        # id_cut = electrons.mvaFall17V2Iso_WPL == True # run3: run2 selection
