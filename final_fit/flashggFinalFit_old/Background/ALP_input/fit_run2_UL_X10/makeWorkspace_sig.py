...
mvaCuts = {1:0.935, 2:0.98, 3:0.985, 4:0.98, 5:0.985, 6:0.99, 7:0.985, 8:0.99, 9:0.99, 10:0.99, 15:0.99, 20:0.99, 25:0.985, 30:0.97}
...
for year in ['16', '16APV','17','18']:
    ...
    for mass_H in [125 - shift, 125, 125 + shift]:
        ...
        for jentry in range(entries):
            ...
            CMS_hza_weight.setVal(mychain.factor*mychain.pho1SFs*mychain.pho2SFs*10.0)
            dataset.add(ArgSet,mychain.factor*mychain.pho1SFs*mychain.pho2SFs*10.0)
