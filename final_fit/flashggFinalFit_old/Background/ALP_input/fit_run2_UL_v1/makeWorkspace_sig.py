...
for year in ['16', '16APV','17','18']:
    ...
    for mass_H in [125 - shift, 125, 125 + shift]:
        ...
        if args.ele:
            w.writeToFile("ALP_data_sig_Am{0}_Hm{1}_{2}_workspace_ele_M30Only.root".format(mass,mass_H,year))
        elif args.mu:
            w.writeToFile("ALP_data_sig_Am{0}_Hm{1}_{2}_workspace_mu_M30Only.root".format(mass,mass_H,year))
        else:
