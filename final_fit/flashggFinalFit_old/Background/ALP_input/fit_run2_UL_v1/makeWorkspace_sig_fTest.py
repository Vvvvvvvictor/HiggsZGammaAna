...
for year in ['16','16APV','17','18']:
    ...
    if args.ele:
        w.writeToFile("ALP_data_sig_Am{0}_{1}_workspace_ele_M30Only.root".format(mass,year))
    elif args.mu:
        w.writeToFile("ALP_data_sig_Am{0}_{1}_workspace_mu_M30Only.root".format(mass,year))
    else:
