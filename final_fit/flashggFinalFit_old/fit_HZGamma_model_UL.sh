...
# python makeWorkspace_data_cats.py -t test -d /eos/home-j/jiehan/root/outputs/two_jet/data.root -j /eos/home-j/jiehan/root/outputs/significances/bin_binaries_1D_two_jet.txt -o ./jet2_run2 
# python makeWorkspace_sig_cats_vbf.py -t test -d /eos/home-j/jiehan/root/outputs/two_jet/sig.root -j /eos/home-j/jiehan/root/outputs/significances/bin_binaries_1D_two_jet.txt -o ./jet2_run2 
