...
for cat in cats:
    for m in method:
        file_obs_name = "higgsCombine_{}_{}.GoodnessOfFit.mH125.root".format(cat, m)
        file_toy_name = "higgsCombine_{}_{}.GoodnessOfFit.mH125.12345.root".format(cat, m)
        ...
        print "Cat:",cat,", Method:", m, ", number of toys:", n_toy, "p_obs:", obs, "p_value:", p_value
