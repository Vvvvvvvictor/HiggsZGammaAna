...
parser.add_argument("-d", "--data", dest="data", type=str, default="./two_jet/zg.root", help="path to the input dataset")
...
parser.add_argument("-o", "--out", dest="out", type=str, default="./two_jet_data/", help="path to the output dir")
parser.add_argument("-t", "--tree", dest="tree", type=str, default="two_jet", help="name of the tree")
...
for jentry in range(entries):
    ...
    if mychain.gamma_mvaID_WP80<1: continue
...
# getattr(w,'import')(data_mass_cats[0])
for c in range(nCat):
    getattr(w,'import')(data_mass_cats[c])


w.writeToFile(args.out+"/HZGamma_ZG_bkg_workspace.root")
del w
