...
#     combine --floatOtherPOIs 0 --expectSignal 1 -t -1 -P r --algo grid --alignEdges 1 --saveSpecifiedNuis all --cminDefaultMinimizerStrategy 0 --X-rtd MINIMIZER_freezeDisassociatedParams --X-rtd MINIMIZER_multiMin_hideConstants --X-rtd MINIMIZER_multiMin_maskConstraints --X-rtd MINIMIZER_multiMin_maskChannels=2 -M MultiDimFit -m 125.0 -d ../output_datacard_rootfile_/Datacard_2017_${cat}__mu_inclusive.root --setParameterRanges r=0,10 --points 21 -n _scan1D_syst_r_${cat}.statOnly --freezeParameters allConstrainedNuisances
#     # combine --floatOtherPOIs 0 --expectSignal 1 -t -1 -P r --algo grid --alignEdges 1 --saveSpecifiedNuis all --cminDefaultMinimizerStrategy 0 --X-rtd MINIMIZER_freezeDisassociatedParams --X-rtd MINIMIZER_multiMin_hideConstants --X-rtd MINIMIZER_multiMin_maskConstraints --X-rtd MINIMIZER_multiMin_maskChannels=2 -M MultiDimFit -m 125.0 -d higgsCombine${cat}.MultiDimFit.mH125.root --setParameterRanges r=-4,0 --points 81 -n _scan1D_syst_r_${cat}_p-4to0 --snapshotName "MultiDimFit" --skipInitialFit

#     # combine --floatOtherPOIs 0 --expectSignal 1 -t -1 -P r --algo grid --alignEdges 1 --saveSpecifiedNuis all --cminDefaultMinimizerStrategy 0 --X-rtd MINIMIZER_freezeDisassociatedParams --X-rtd MINIMIZER_multiMin_hideConstants --X-rtd MINIMIZER_multiMin_maskConstraints --X-rtd MINIMIZER_multiMin_maskChannels=2 -M MultiDimFit -m 125.0 -d ../output_datacard_rootfile_/Datacard_2017_${cat}__mu_inclusive.root --setParameterRanges r=-0,6 --points 121 -n _scan1D_syst_r_${cat}_p0to6

#     # combineTool.py -d ../output_datacard_rootfile_/Datacard_2017_${cat}__mu_inclusive.root -n _scan1D_syst_r_${cat} -M MultiDimFit --algo grid --points 50 --noMCbonly 1  --cminDefaultMinimizerStrategy 0 --cminApproxPreFitTolerance=100  --cminFallbackAlgo Minuit2,Migrad,0:0.1 --cminDefaultMinimizerTolerance 0.1 --X-rtd MINIMIZER_MaxCalls=9999999  --X-rtd MINIMIZER_analytic --X-rtd FAST_VERTICAL_MORPH  --X-rtd MINIMIZER_freezeDisassociatedParams  --X-rtd OPTIMIZE_BOUNDS=0  -v 3  --setParameterRanges r=0,5 -m 125.38  --floatOtherPOIs 1 --X-rtd NO_INITIAL_SNAP  --X-rtd MINIMIZER_multiMin_hideConstants --X-rtd MINIMIZER_multiMin_maskConstraints --X-rtd MINIMIZER_multiMin_maskChannels=2  --saveWorkspace --alignEdges 1
