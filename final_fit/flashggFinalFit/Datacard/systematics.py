...
theory_systematics = [
                ...
                #{'name':'weight_LHEScal_0','title':'CMS_hzg_scaleWeight_0','type':'factory','prior':'lnN','correlateAcrossYears':1,'tiers':['shape']}, 
                #{'name':'weight_LHEScal_1','title':'CMS_hzg_scaleWeight_1','type':'factory','prior':'lnN','correlateAcrossYears':1,'tiers':['shape']},
                #{'name':'weight_LHEScal_2','title':'CMS_hzg_scaleWeight_2','type':'factory','prior':'lnN','correlateAcrossYears':1,'tiers':['shape']}, #Unphysical
                #{'name':'weight_LHEScal_3','title':'CMS_hzg_scaleWeight_3','type':'factory','prior':'lnN','correlateAcrossYears':1,'tiers':['shape']},
                #{'name':'weight_LHEScal_4','title':'CMS_hzg_scaleWeight_4','type':'factory','prior':'lnN','correlateAcrossYears':1,'tiers':['shape']}, # nominal weight
                #{'name':'weight_LHEScal_5','title':'CMS_hzg_scaleWeight_5','type':'factory','prior':'lnN','correlateAcrossYears':1,'tiers':['shape']}, 
                #{'name':'weight_LHEScal_6','title':'CMS_hzg_scaleWeight_6','type':'factory','prior':'lnN','correlateAcrossYears':1,'tiers':['shape']}, #Unphysical
                #{'name':'weight_LHEScal_7','title':'CMS_hzg_scaleWeight_7','type':'factory','prior':'lnN','correlateAcrossYears':1,'tiers':['shape']},
                #{'name':'weight_LHEScal_8','title':'CMS_hzg_scaleWeight_8','type':'factory','prior':'lnN','correlateAcrossYears':1,'tiers':['shape']},
                # {'name':'weight_AlphaS','title':'CMS_hzg_AlphaS','type':'factory','prior':'lnN','correlateAcrossYears':1,'tiers':['shape']},
                # {'name':'weight_PS_ISR','title':'CMS_hzg_PS_ISR','type':'factory','prior':'lnN','correlateAcrossYears':1,'tiers':['shape']},
                # {'name':'weight_PS_FSR','title':'CMS_hzg_PS_FSR','type':'factory','prior':'lnN','correlateAcrossYears':1,'tiers':['shape']}

              ]

# PDF weight
#for i in range(1,101): theory_systematics.append( {'name':'weight_LHEPd_%g'%i, 'title':'CMS_hzg_pdfWeight_%g'%i, 'type':'factory','prior':'lnN','correlateAcrossYears':1,'tiers':['shape']} )
...
experimental_systematics = [
                ...
                {'name':'weight_L1_prefiring_sf', 'title':'CMS_hzg_L1PrefiringWeight','type':'factory','prior':'lnN','correlateAcrossYears':1},
                {'name':'weight_pu_reweight_sf','title':'CMS_hzg_PileupWeight','type':'factory','prior':'lnN','correlateAcrossYears':1},
                # {'name':'weight_TriggerSF','title':'CMS_hzg_TriggerWeight','type':'factory','prior':'lnN','correlateAcrossYears':1},
                {'name':'weight_electron_veto_sf_Photon','title':'CMS_hzg_ElectronVetoSF','type':'factory','prior':'lnN','correlateAcrossYears':1},
                # {'name':'weight_PreselSF','title':'CMS_hzg_PreselSF','type':'factory','prior':'lnN','correlateAcrossYears':1},
                # {'name':'weight_SF_photon_ID','title':'CMS_hzg_phoIdMva','type':'factory','prior':'lnN','correlateAcrossYears':1},
                {'name':'weight_electron_wplid_sf_SelectedElectron','title':'CMS_hzg_ElectronWPLIDSF','type':'factory','prior':'lnN','correlateAcrossYears':1},
                {'name':'weight_muon_looseid_sf_SelectedMuon','title':'CMS_hzg_MuonLooseIDSF','type':'factory','prior':'lnN','correlateAcrossYears':1},
                #{'name':'energyErrShift','title':'CMS_hzg_SigmaEOverEShift','type':'factory','prior':'lnN','correlateAcrossYears':1}
                
                {'name':'JER','title':'CMS_hzg_res_j','type':'factory','prior':'lnN','correlateAcrossYears':0},
                {'name':'JES','title':'CMS_hzg_scale_j','type':'factory','prior':'lnN','correlateAcrossYears':0},
                {'name':'MET_JES', 'title':'CMS_hzg_scale_j','type':'factory','prior':'lnN','correlateAcrossYears':0},
                {'name':'MET_Unclustered', 'title':'CMS_hzg_MET_Unclustered','type':'factory','prior':'lnN','correlateAcrossYears':0}
              ]
