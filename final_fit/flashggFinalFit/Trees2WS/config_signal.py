...
trees2wsCfg = {
  ...
  'mainVars':["H_mass","weight", "dZ", "weight_*"], # Vars to add to nominal RooDatasets ‘dZ’ may be necessary
  ...
  'systematicsVars':["CMS_hzg_mass","weight"], # Variables to add to sytematic RooDataHists
  ...
  'systematics':["scale","smear","fnuf","material","JER","JES","MET_JES","MET_Unclustered","Muon_pt"],
