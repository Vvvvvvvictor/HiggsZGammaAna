...
ol = '/afs/cern.ch/work/c/chuw/HHWWgg/flashggFinalFit/CMSSW_10_2_13/src/flashggFinalFit/Plots/FinalResults/'
...
def main():
    ...
    if args.SM_Radion: 
	    ...
	    masses = [249.0, 249.2, 249.4, 249.6, 249.8, 250., 250.2, 250.4, 250.6, 250.8, 251.0]
	    for m in masses:
            	values.append(m)
