...
#sysList = ['normal', 'phoSmear_up', 'phoSmear_dn']
...
def draw_DataModel(mass,hist,model,path_out,float_val):
...
def creat_outTXT(float_param_bestFit, path_out):
            ...
            for sys in sysList:
                ...
                if s !=0:
                    ...
                    for step in steps:
                        ...
                        chi2_temp = get_chi2(mass_,data[sys],model_temp)
                ...
                if verbose>1: draw_DataModel(mass_,data[sys],model[sys],path_out+"M{0}/m{0}_{1}_{2}_DataModel.png".format(a_mass,year,sys), sys+"_float: "+str(float_best))

            #draw_ScaleSmear(mass_, data, model, path_out+"M{0}/m{0}_{1}_ScaleSmear.png".format(a_mass,year))
            creat_outTXT(float_param_bestFit, path_out+"M{0}/ScaleSmear_m{0}_{1}.dat".format(a_mass,year))
