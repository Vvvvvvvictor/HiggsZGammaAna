...
nBins = [50, 50, 100, 100, 220, 220, 150, 200, 200, 220, 220, 180, 220, 250, 220, 300, 200, 200, 50, 200, 180, 180, 50, 200, 200, 200, 200, 250, 130, 150, 200, 250, 220, 200, 93, 50, 150, 200, 200, 200, 220, 200, 200, 200, 150, 250, 200, 200, 100, 200, 200, 200, 200, 200, 500, 250]
        ...
        for year in years:
            ...
            for sys in sysList:
                ...
                if s !=0:
                    ...
                    #steps = np.linspace(-0.05,0.05,201).tolist()
                    #print steps
                    for step in steps:
