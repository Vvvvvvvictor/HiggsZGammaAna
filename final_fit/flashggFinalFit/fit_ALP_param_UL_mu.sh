...
nBins=( 200 200 200 200 200 200 300 200 180 200 200 200 200 220 215 180 180 220 200 200 200 200 200 200 220 195 200 200 120 190 200 200 190 200 200 180 220 200 190 200 200 150 200 200 220 200 130 200 190 200 400 200 200 200 200 200 ) ## Sum-n Gaus
#nBins=80
...
for ((iBin=0; iBin<$nMass; iBin++))
    ...
    for ((jBin=0; jBin<$nYear; jBin++))
      ...
      #./bin/makeParametricSignalModelPlots_ALP -i $path_out_bkg/CMS-HGG_sigfit_data_ggh_cat0.root  -o $path_out_bkg/SignalModel -p ggh -f cat0 -L 100 -H 135 -m 125 #--useDCBplusGaus 1
